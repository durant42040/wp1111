...
const ScoreCard = ({game}) => {
    ...
    if (game.period === 0 || game.hgameLeader?.name) return (
        <Card className='card3' sx={{borderRadius: 0}}>
            <CardContent sx={{
                height: '100%', width: '100%', alignItems: 'center', padding: '16px 16px 0 16px',
            }}>
                <Grid container spacing={2} sx={{
                        ...
                        <Box sx={{display: 'flex', marginTop: '10px', justifyContent: 'space-between'}}>
                            <Box sx={{display: 'flex', maxHeight: '42px'}}>
                                ...
                                <TableContainer component={Paper} sx={{
                                    display: !game.hgameLeader?.name && 'none',
                                    boxShadow: 'none',
                                    position: 'relative',
                                    bottom: '60px',
                                    left: '20px',
                    ...
                    {game.period !== 0 &&
                        <Grid item xs={2} sx={{textAlign: 'left', display: 'block', position: 'relative', top: '0px'}}>
